                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('offers.update', $offer) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="title" type="text" name="title" value="{{ old('title', $offer->title) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" name="description" rows="5"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description', $offer->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div id="skills-container">
                                @foreach (old('required_skills', $offer->required_skills) as $skill)
                        ...
                        <div class="mb-4">
                            ...
                            <input id="minimum_experience" type="number" name="minimum_experience" value="{{ old('minimum_experience', $offer->minimum_experience) }}" min="0"
                                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
