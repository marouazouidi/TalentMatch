...
Authenticated HR agents can submit candidate CVs for AI-powered analysis against job offers. The system processes analyses asynchronously via a queue, validates AI responses against a strict schema, and persists structured evaluations including matching scores, recommendations, skills, and candidate information.
