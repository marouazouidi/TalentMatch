...
Authenticated HR agents can create, view, update, and delete job offers. Each offer includes a title, description, required skills, and minimum experience requirements. Users own their offers and can only access their own data.
